import img_story_1 from "../img/story-1.jpeg";
import img_story_2 from "../img/story-2.jpeg";
import img_house_1 from "../img/house-1.jpeg";
import img_house_2 from "../img/house-2.jpeg";
import img_house_3 from "../img/house-3.jpeg";
import img_house_4 from "../img/house-4.jpeg";
import img_house_5 from "../img/house-5.jpeg";
import img_house_6 from "../img/house-6.jpeg";
import gallery_img_1 from "../img/gal-1.jpeg";
import gallery_img_2 from "../img/gal-2.jpeg";
import gallery_img_3 from "../img/gal-3.jpeg";
import gallery_img_4 from "../img/gal-4.jpeg";
import gallery_img_5 from "../img/gal-5.jpeg";
import gallery_img_6 from "../img/gal-6.jpeg";
import gallery_img_7 from "../img/gal-7.jpeg";
import gallery_img_8 from "../img/gal-8.jpeg";
import gallery_img_9 from "../img/gal-9.jpeg";
import gallery_img_10 from "../img/gal-10.jpeg";
import gallery_img_11 from "../img/gal-11.jpeg";
import gallery_img_12 from "../img/gal-12.jpeg";
import gallery_img_13 from "../img/gal-13.jpeg";
import gallery_img_14 from "../img/gal-14.jpeg";
import logo from "../img/logo.png";
import logo_bbc from "../img/logo-bbc.png";
import logo__forbes from "../img/logo-forbes.png";
import logo_tech from "../img/logo-techcrunch.png";
import logo_bi from "../img/logo-bi.png"
import dealer_img_1 from "../img/realtor-1.jpeg"
import dealer_img_2 from "../img/realtor-2.jpeg"
import dealer_img_3 from "../img/realtor-3.jpeg"
    ...
    <body className="container">
      ...
      <header className="header">
        ...
        <div className="header__seenon-logos">
          <img src={logo_bbc} alt="BBC Logo"/>
          <img src={logo__forbes} alt="forbes logo" />
          <img src={logo_tech} alt="tech crunch logo" />
          <img src={logo_bi} alt="bi logo" />
        </div>
      </header>
      <div className="dealers">
        
        <h3 className="heading-3">Top 3 Dealers</h3>
        <div className="dealers__list">
          <img src={dealer_img_1} alt="Dealer image 1" className="dealers__img" />
          <div className="dealers__details">
            <h4 className="heading-4 heading-4--light">Praveen</h4>
            <p className="dealers__sold">245 houses sold</p>
          </div>
          <img src={dealer_img_2} alt="Dealer image 2" className="dealers__img" />
          <div className="dealers__details">
            <h4 className="heading-4 heading-4--light">Pushpa</h4>
            <p className="dealers__sold">245 houses sold</p>
          </div>
          <img src={dealer_img_3} alt="Dealer image 3" className="dealers__img" />
          <div className="dealers__details">
            <h4 className="heading-4 heading-4--light">Naveen</h4>
            <p className="dealers__sold">245 houses sold</p>
          </div>
        </div>
        </div>
      <section className="features">
        ...
        <div className="feature">
          ...
          <p className="feature__text">
            Discover the epitome of opulence with the world's most exquisite and
            lavish luxury homes. Experience pure indulgence.
          </p>
        </div>
        <div className="feature">
          <svg
          ...
          <p className="feature__text">
            Uncover unparalleled perfection with our exclusive selection of the
            world's finest and most coveted properties.
          </p>
        </div>
        <div className="feature">
          <svg
          ...
          <p className="feature__text">
            Experience the pinnacle of prime real estate with our collection of
            luxury homes in sought-after, prestigious locations.
          </p>
        </div>
        <div className="feature">
          <svg
          ...
          <p className="feature__text">
            Get ready to move into your dream home swiftly. our efficient
            service delivers a new home in just one week!
          </p>
        </div>
        <div className="feature">
          <svg
          ...
          <p className="feature__text">
            Trust the expertise of the elite - our top 1% realtors are here to
            guide you to exceptional properties.
          </p>
        </div>
        <div className="feature">
          <svg
          ...
          <p className="feature__text">
            Experience peace of mind with secure payments on Nest, ensuring a
            smooth and trustworthy transaction process.
          </p>
        </div>
      </section>
      ...
      <div className="story__content">
        ...
        <p className="story__text">
          Absolutely thrilled with our new home! Incredible service, flawless
          process. Thank you for making our dreams come true!
        </p>
      ...
      <section className="homes">
        {/*     .home{Home card$}*6     */}
        <div className="home">
          <img src={img_house_1} alt="House 1" className="home__img" />
          <h5 className="home__name">Beautiful Family</h5>
          <div className="home__location">
            <svg fill="currentColor" viewBox="0 0 24 32">
              <path d="M12 0c-6.617 0-12 5.394-12 12.022 0 9.927 11.201 19.459 11.678 19.86 0.093 0.079 0.208 0.118 0.322 0.118s0.226-0.038 0.318-0.114c0.477-0.394 11.682-9.762 11.682-19.864 0-6.628-5.383-12.022-12-12.022zM12.002 30.838c-1.841-1.645-11.002-10.259-11.002-18.816 0-6.078 4.935-11.022 11-11.022s11 4.944 11 11.022c0 8.702-9.152 17.193-10.998 18.816zM12 6c-3.309 0-6 2.691-6 6s2.691 6 6 6 6-2.691 6-6-2.691-6-6-6zM12 17c-2.757 0-5-2.243-5-5s2.243-5 5-5 5 2.243 5 5-2.243 5-5 5z"></path>
            </svg>
            <p>Bangalore</p>
          </div>
          <div className="home__rooms">
            <svg fill="currentColor" viewBox="0 0 36 32">
          ...
          <button className="btn home__btn">Contact Dealer</button>
        </div>

        <div className="home">
          <img src={img_house_2} alt="House 1" className="home__img" />
        ...
        <div className="home">
          <img src={img_house_3} alt="House 1" className="home__img" />
        ...
        <div className="home">
          <img src={img_house_4} alt="House 1" className="home__img" />
        ...
        <div className="home">
          <img src={img_house_5} alt="House 1" className="home__img" />
        ...
        <div className="home">
          <img src={img_house_6} alt="House 1" className="home__img" />
      ...
      <section className="gallery">
        {/*figure.gallery__item.gallery__item--$>img.gallery__img[src={gallery_img_$}][alt="Gallery image $"]*/}
        <figure className="gallery__item gallery__item--1"><img src={gallery_img_1} alt="Gallery Image 1" className="gallery__img" /></figure>
        <figure className="gallery__item gallery__item--2"><img src={gallery_img_2} alt="Gallery Image 2" className="gallery__img" /></figure>
        <figure className="gallery__item gallery__item--3"><img src={gallery_img_3} alt="Gallery Image 3" className="gallery__img" /></figure>
        <figure className="gallery__item gallery__item--4"><img src={gallery_img_4} alt="Gallery Image 4" className="gallery__img" /></figure>
        <figure className="gallery__item gallery__item--5"><img src={gallery_img_5} alt="Gallery Image 5" className="gallery__img" /></figure>
        <figure className="gallery__item gallery__item--6"><img src={gallery_img_6} alt="Gallery Image 6" className="gallery__img" /></figure>
        <figure className="gallery__item gallery__item--7"><img src={gallery_img_7} alt="Gallery Image 7" className="gallery__img" /></figure>
        <figure className="gallery__item gallery__item--8"><img src={gallery_img_8} alt="Gallery Image 8" className="gallery__img" /></figure>
        <figure className="gallery__item gallery__item--9"><img src={gallery_img_9} alt="Gallery Image 9" className="gallery__img" /></figure>
        <figure className="gallery__item gallery__item--10"><img src={gallery_img_10} alt="Gallery Image 10" className="gallery__img" /></figure>
        <figure className="gallery__item gallery__item--11"><img src={gallery_img_11} alt="Gallery Image 11" className="gallery__img" /></figure>
        <figure className="gallery__item gallery__item--12"><img src={gallery_img_12} alt="Gallery Image 12" className="gallery__img" /></figure>
        <figure className="gallery__item gallery__item--13"><img src={gallery_img_13} alt="Gallery Image 13" className="gallery__img" /></figure>
        <figure className="gallery__item gallery__item--14"><img src={gallery_img_14} alt="Gallery Image 14" className="gallery__img" /></figure>
      </section>

      <footer className="footer">
        <ul className="ul">
          <li className="ul__item"><a href="#" className="ul__link">Find your dream home</a></li>
          <li className="ul__item"><a href="#" className="ul__link">Request Proposal</a></li>
          <li className="ul__item"><a href="#" className="ul__link">download home planner</a></li>
          <li className="ul__item"><a href="#" className="ul__link">contact us</a></li>
          <li className="ul__item"><a href="#" className="ul__link">submit your property</a></li>
          <li className="ul__item"><a href="#" className="ul__link">Careers</a></li>
        </ul>
        <p className="copyright">
          &copy; Copyright 2023 by Praveen CM. All rights Reserved
        </p>
        </footer>
    </body>
  );
